...
import IOtherFrevoEntityService from 'src/domain/services/iotherFrevoEntity.service';
import OtherFrevoEntityRepository from 'src/infra/repositories/otherFrevoEntity.repository';
